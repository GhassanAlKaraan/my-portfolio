# Portfolio
I'm personalizing this template to create my unique portfolio, incorporating custom code to suit my preferences.

## Unemployables Portfolio Template
A creative portfolio template uzing HTML, CSS, and JavaScript.
<br /><br />

## Ignore the below manual 
